...
class EncryptionConfigScreenComponent extends React.Component {
	...
	renderMasterKey(mk) {
		...
		return React.createElement(
			...
			React.createElement(
				'td',
				{ style: theme.textStyle },
				time.formatMsToLocal(mk.updated_time)
			),
			React.createElement(
				'td',
				{ style: theme.textStyle },
				React.createElement('input', { type: 'password', style: passwordStyle, value: password, onChange: event => onPasswordChange(event) }),
				' ',
				React.createElement(
					'button',
					{ style: theme.buttonStyle, onClick: () => onSaveClick() },
					_('Save')
				)
			),
			React.createElement(
	...
	render() {
		...
		const decryptedItemsInfo = React.createElement(
			'p',
			{ style: theme.textStyle },
		...
		if (mkComps.length) {
			masterKeySection = React.createElement(
				'div',
				null,
				React.createElement(
					'h1',
		...
		if (nonExistingMasterKeyIds.length) {
			...
			nonExistingMasterKeySection = React.createElement(
				'div',
				null,
				React.createElement(
					'h1',
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ style: { backgroundColor: theme.warningBackgroundColor, paddingLeft: 10, paddingRight: 10, paddingTop: 2, paddingBottom: 2 } },
					React.createElement(
						'p',
						{ style: theme.textStyle },
						React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'strong',
						null,
						this.props.encryptionEnabled ? _('Enabled') : _('Disabled')
					)
				),
				decryptedItemsInfo,
				toggleButton,
