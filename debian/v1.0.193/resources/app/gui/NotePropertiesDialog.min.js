...
class NotePropertiesDialog extends React.Component {
	...
	createNoteField(key, value) {
		...
		const labelComp = React.createElement(
			'label',
			{ style: Object.assign({}, theme.textStyle, theme.controlBoxLabel) },
		...
		if (this.state.editedKey === key) {
			...
			if (['source_url', 'location'].indexOf(key) >= 0) {
				...
				controlComp = React.createElement(
					'div',
					{ style: Object.assign({}, theme.textStyle, theme.controlBoxValue) },
					displayedValue
				);
			}
		...
		return React.createElement(
			'div',
			{ key: key, style: theme.controlBox, className: 'note-property-box' },
			labelComp,
			controlComp,
			editComp
		);
